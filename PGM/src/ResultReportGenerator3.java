...
public class ResultReportGenerator3 {

	static String[] pgms = {"17_4_s.binary", "54.wcsp"};
	static double[] pgmlogresults = {-38.1283, 16.4536};
	...
	public static void main(String args[]) throws Exception {
		bw = new BufferedWriter(new FileWriter("util3.log"));
