...
public class EMParameterLearning {
	...
	public static void main(String args[]) throws Exception {
		...
		mgr.learnNetworkParametersPODEM(lrndNetwork, dataSet);
		...
		Util.log("Log Likelihood Difference: "+lld);
 		Util.log("EMParameterLearning: Total execution time->"+((double)(System.currentTimeMillis()-startTime)/1000)+" secs.");
	}
