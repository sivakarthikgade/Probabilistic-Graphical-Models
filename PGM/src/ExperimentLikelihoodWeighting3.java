...
public class ExperimentLikelihoodWeighting3 {
	...
	public static void main(String args[]) throws Exception {
		ExperimentLikelihoodWeighting3 exp = new ExperimentLikelihoodWeighting3();
		
		exp.uaiFile = args[0];
		exp.evidFile = args[1];
		exp.poe = Double.parseDouble(args[2]);
		
		BufferedWriter bw = new BufferedWriter(new FileWriter(exp.uaiFile.substring(0, exp.uaiFile.lastIndexOf(".")) + "-result3.csv.log"));
