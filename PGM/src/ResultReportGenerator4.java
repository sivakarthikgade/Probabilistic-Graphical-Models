...
public class ResultReportGenerator4 {

	static String[] pgms = {"404.wcsp", "grid16_5", "grid18_10"};
	static double[] pgmlogresults = {15.3037, 194.848, 341.492};
	...
	public static void main(String args[]) throws Exception {
		bw = new BufferedWriter(new FileWriter("util4.log"));
